...
# python3 train_heatmap_only.py --model TextHeatmapSubCNNSigmoid --epochs 5 -n 1 -g 4 --lr 0.05 --expno 41 --pos_weight 6.5661 --checkpoint 1

python3 train_heatmap_only.py --model SimplifiedTextHeatmapSigmoid --epochs 10 -n 1 -g 8 --lr 0.05 --expno 42 --pos_weight 6.5661