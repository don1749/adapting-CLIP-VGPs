...
def train(gpu, args):
    ...
    for epoch in range(args.checkpoint, args.epochs):
        ...
        torch.save({'epoch': epoch,
                   ...
                   '/work/adapting-CLIP-VGPs/checkpoints/text+heatmap2/checkpoint{}.pt'.format(epoch + 1)) 
         # Save the training history after each epoch
        with open('/work/adapting-CLIP-VGPs/checkpoints/text+heatmap2/training_history.json', 'a') as f:
